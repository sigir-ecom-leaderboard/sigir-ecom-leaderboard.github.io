fetch("https://sigir-ecom-leaderboard.github.io/score_final.json")
  .then(res => res.json())
  .then((homework) => {console.log(homework);

var d = new Date();
var lastUpdated = d.toLocaleString();
var scoreDiv = document.getElementById("finalscorediv");
var updatedDiv = document.getElementById("finalupdatedDiv");
